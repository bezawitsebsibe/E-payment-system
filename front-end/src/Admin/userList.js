    ...
    Modal.confirm({
      ...
      onOk: () => {
        ...
        form.validateFields().then((values) => {
          ...
          // Update user data
          axios
            .put(`http://localhost:3001/Users/${updatedUser.id}`, updatedUser)
            .then((response) => {
              if (response.status === 200) {
                // Upload file separately
                axios
                  .put(`http://localhost:3001/Users/${updatedUser.id}`, formData)
                  .then((uploadResponse) => {
    ...
    },
    {
      ...
      render: (_, user) => (
        <div>
          {user.ProfilePicture && (
            <div>
              <a href={`http://localhost:3001/Users/${user.ProfilePicture}`} download>
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  downloadLink.href = `http://localhost:3001/Users/${user.ProfilePicture}`;
